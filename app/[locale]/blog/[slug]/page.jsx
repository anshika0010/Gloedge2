...
const page = ({params}) => {
  ...
  return (
    <>
        ...
        <div className='container mx-auto relative mt-38'>
            <Image
            src={blogicon}
            alt='icon'
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-5 items-start">
          <div className="lg:w-3/1 space-y-6 bg-white">
            <div className="max-w-4xl mx-auto px-4 py-10 ">
              <p className="text-sm text-gray-500">Posted on April 09 2025</p>
              <h1 className="text-2xl font-bold text-gray-900 mt-2">
                Can I apply directly for the 191 visa?
              </h1>
              <p className="text-gray-600 mt-1">
                By <span className="font-semibold">Anshul Singhal, Editor</span>{" "}
                <br />
                Updated April 09 2025
              </p>

              <p className="mt-6 text-gray-700 leading-relaxed">
                No, you cannot directly apply for the 191 visa. To be eligible,
                you must have a valid regional provisional visa and hold it for
                at least three years. The 191 visa is the two-step process to
                permanent residency in Australia. First, you must obtain a
                regional provisional visa that needs a subclass 491 (Skilled
                Work Regional) or 494 (Skilled Employer Sponsored Regional).
              </p>
              ...
              <p className="italic text-sm text-gray-600">
                *Want to guidance to apply for Australia PR? X-Axis is here to
                offer you comprehensive support with the process.*
              </p>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                also known as the 191 visa, is a pathway to Australia for
                individuals who have lived and worked in Australia's regional
                areas through a provisional visa, such as a 491 or 494 visa, for
              ...
              <p className="text-gray-700">
                To be eligible for the 191 visa, you must fulfill the conditions
                given below. You must:
              </p>

              <ul className="list-disc pl-6 mt-4 space-y-2 text-gray-700">
                <li>Hold a qualifying visa</li>
                <li>
                  Provide assessment-based notices authorized by the Australian
                  Taxation Office for 3 income years of 5 years validity of your
                  qualifying visa
                </li>
                ...
                <li>Pay back debts to the Government of Australia (if any)</li>
                <li>
                  Not have visa cancellation or refusal of application earlier
                </li>
              </ul>
              ...
              <p className="italic text-sm text-gray-600">
                *Looking for assistance to apply for 191 in Australia? X-Axis is
                here to offer complete guidance.*
              </p>
            </div>
            <div className="max-w-3xl mx-auto p-6 text-gray-800">
              ...
              <p className="mb-2">
                The eligibility conditions of the 491 visa are given below. You
                must:
              </p>
              <ul className="list-disc list-inside space-y-1 mb-4">
                <li>
                  Have a nomination by a state or territory of Australia agency
                  or sponsorship by an eligible family member.
                </li>
                <li>
                  Be employed in an occupation listed in a relevant skilled
                  occupation list
                </li>
                <li>Have the required skills assessment for the job role</li>
                <li>Have an invitation to apply for the 491 visa</li>
                <li>
                  Have a score of 65 points or more in the points grid system
                </li>
              </ul>
              <p className="mb-6 text-blue-600 underline cursor-pointer">
                Australia announces the new Designated Area Migration from March
                2025 to 2030
              </p>
              ...
              <p className="mb-2">
                The eligibility criteria for the 494 visa are given below. You
                must:
              </p>
              <ul className="list-disc list-inside space-y-1 mb-4">
                <li>Have nomination by an Australia-based work sponsor.</li>
                <li>
                  Be employed in an occupation listed on the relevant skilled
                  occupation list.
                </li>
                <li>
              ...
              <p className="mb-4">
                The detailed procedure to apply for the 191 visa is given below.
              </p>
              <ol className="list-decimal list-inside space-y-1 mb-4">
                <li>Hold a valid qualifying visa to apply for the 191 visa.</li>
                <li>
                  Check if you meet the other eligibility conditions for the 191
                  visa.
                </li>
                <li>
                ...
                <li>
                  Become an Australian permanent resident with the 191 visa.
                </li>
              </ol>
