      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
            Navigate complex immigration laws and secure business visas for the
            world's top economies. Turn your entrepreneurial vision into global
            reality.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group">
              ...
              <h3 className="text-xl font-bold mb-4">Business Visa Guidance</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group">
              ...
              <p className="text-gray-600">
                Complete support for relocating your family to your new business
                destination
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  "Secured UK Innovator visa for our AI startup. The team guided
                  us through the complex endorsement process seamlessly."
                </p>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3">Canada Start-up Visa</h3>
                <p className="text-gray-600 mb-4">
