  ...
  return (
    <>
      ...
      <div className="mx-4">
        <VisaForm />
        <WorkOpportunity />
        <div className="mx-auto bg-red-600 px-6 py-12 mb-6 mt-4">
          ...
          <div className="flex flex-col md:flex-row gap-7 justify-center items-center mb-4">
            ...
            <button className="bg-white text-red border border-red-600 px-12 py-3 rounded font-semibold hover:bg-red-200 transition">
              Search
            </button>
          </div>
        </div>
