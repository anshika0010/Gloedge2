        ...
        <div className="max-w-sm mx-auto py-6 px-4">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-center space-x-1">
              ...
              />
              <span className="text-gray-700">want to work in</span>
            </div>
            ...
            <div>
              ...
              <div className="flex items-start space-x-2 mb-3">
                ...
                <label className="text-xs text-gray-600">
                  I accept the{" "}
                  <Link href={`/${language}/terms-and-conditions`} className="text-blue-500 underline cursor-pointer">
                    Terms & Conditions
                  </Link>
                </label>
              </div>
              ...
              <button
                ...
                className="w-full bg-[#da010b] hover:bg-teal-600 text-white font-semibold py-2 px-4 rounded-md transition-all duration-300 transform hover:scale-105 text-sm"
              >
                Get Started
              </button>
