          ...
          <div className=" ">
            <div className=" ">
              <Heading
                ...
                className={
                  "text-2xl lg:text-3xl mx-9 mt-5 mb-4 font-semibold text-gray-900 mb-2 hover:text-orange-500 transition-colors duration-300"
                }
              />
              {/* <Heading
                text={""}
                className={
                  "text-2xl lg:text-3xl mx-9 font-bold text-gray-900 mb-2 hover:text-orange-500 transition-colors duration-300"
                }
              /> */}
              <p className="text-gray-600 leading-relaxed mx-9">
                Value packed career counseling, college admissions, student visa
                and coaching solutions.
              </p>
            </div>

            <div className="py-4 space-y-2 mx-9">
