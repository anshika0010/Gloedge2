  ...
  return (
    <div className="w-full bg-white py-10">
      <div className="container mx-auto border border-gray-300 rounded-sm shadow-sm p-8 text-center">
        ...
        <Heading
          text={"Study Abroad Super Saver Package"}
          className="flex justify-center text-2xl md:text-3xl font-bold text-gray-900"
        />
        ...
        >
          {[
            ...
            <div
              key={index}
              className="flex items-center gap-2 study-abroad-points"
            >
        ...
        <div className="mt-8">
          <a
            ...
            className="max-w-[fit-content] relative Allbtn font-semibold px-6 py-2 flex items-center gap-2 mx-auto shadow-md"
          >
